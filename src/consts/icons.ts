export enum EIconName {
  ...
  COINS_PURPLE = 'coins_purple',
  FLASH_PURPLE = 'flash_purple',
  HAND_RAISE_PURPLE = 'hand_raise_purple',
  HAND_SHAKE_PURPLE = 'hand_shake_purple',
  HOUSE_PURPLE = 'house_purple',
  ROCKET_PURPLE = 'rocket_purple',
  MENU = 'menu',
  SEARCH = 'search',
  CIRCLE = 'circle',
